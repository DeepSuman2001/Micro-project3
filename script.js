...
function listVegetableFoodItems() {
  return foodlist.filter((food) => food.category === 'Vegetable');
}

//List all the food items with category fruit
function listFruitFoodItems() {
  return foodlist.filter((food) => food.category === 'Fruit');
}

//List all the food items with category protein
function listProteinFoodItems() {
  return foodlist.filter((food) => food.category === 'Protein');
}

//List all the food items with category nuts
function listNutsFoodItems() {
  return foodlist.filter((food) => food.category === 'Nuts');
}

//List all the food items with category grains
function listGrainsFoodItems() {
  return foodlist.filter((food) => food.category === 'Grain');
}

//List all the food items with category dairy
function listDairyFoodItems() {
  return foodlist.filter((food) => food.category === 'Dairy');
}

//List all the food items with calorie above 100
function listFoodItemsAboveCalorie(calorie) {
  return foodlist.filter((food) => food.calorie > calorie);
}
